...
import logging
from src.utils.models import ExtractionResult, AssetPipelineResult

class AssetPipeline(Protocol):
    def process(self, extracted: ExtractionResult, d_asset_subcategory_lazy: pl.LazyFrame, logger: logging.Logger) -> AssetPipelineResult:
        """
...
class MutualFundPipeline:
    def process(self, extracted: ExtractionResult, d_asset_subcategory_lazy: pl.LazyFrame, logger: logging.Logger) -> AssetPipelineResult:
        ...
        master_ref = get_stg_mf_master_ref(market_data, purchase_trans, sale_trans, d_asset_subcategory_lazy)
